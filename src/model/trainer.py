...
class Trainer(object):
    ...
    def test(self, sess, print_paths=False, save_model=True, beam=True, load_model=False):
...
if __name__ == '__main__':
    ...
    if not options['load_model']:
        ...
        with tf.compat.v1.Session(config=config) as sess:
            ...
            trainer.paths_log = output_dir
            trainer.test_environment = trainer.test_test_environment
            trainer.test(sess, print_paths=True, save_model=False, load_model=True)
